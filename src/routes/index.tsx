...
function WhatsAppFloat() {
  return (
    <a
      ...
      rel="noreferrer"
      aria-label="WhatsApp"
      className="fixed bottom-6 right-6 z-50 inline-flex items-center justify-center size-14 rounded-full bg-[#25D366] shadow-[0_4px_14px_rgba(37,211,102,0.45)] hover:scale-110 transition-transform"
    >
